  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title card_title_center">تعديل الوحدة </h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <select name="is_master" id="is_master" class="form-control">
                  ...
                  <option {{  old('is_master',$data['is_master'])==1 ? 'selected' : ''}}   value="1"> وحدة اب</option>
                  <option {{ old('is_master',$data['is_master'])==0 ? 'selected' : ''}}  value="0"> وحدة تجزئة</option>
        ...
        @endif
        <a href="{{ route('admin.uoms.index') }}" class="btn btn-sm btn-success">الغاء</a>
      </div>
    </div>
  </div>
</div>
