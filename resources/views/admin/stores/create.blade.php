...
<div class="row">
    <div class="col-12">
      ...
      <div class="form-group">
        ...
        <input name="phone" id="phone" class="form-control" value="{{ old('phone') }}"  oninvalid="setCustomValidity('من فضلك ادخل هذا الحقل')" onchange="try{setCustomValidity('')}catch(e){}"  >
        @error('phone')
        <span class="text-danger">{{ $message }}</span>
        @enderror
      </div>
      <div class="form-group">
        ...
        <input name="address" id="address" class="form-control" value="{{ old('address') }}"  oninvalid="setCustomValidity('من فضلك ادخل هذا الحقل')" onchange="try{setCustomValidity('')}catch(e){}"  >
        @error('address')
        <span class="text-danger">{{ $message }}</span>
        @enderror
      </div>
