...
<div class="col-md-6"> 
  <div class="form-group"> 
    ...
    <select name="inv_itemcard_categories_id" id="inv_itemcard_categories_id" class="form-control ">
      ...
      @if (@isset($inv_itemcard_categories) && !@empty($inv_itemcard_categories) && count($inv_itemcard_categories)>0)
  ...
  <div class="col-md-6"> 
    ...
    <div class="col-md-6"> 
      ...
      <div class="col-md-6 " @if(old('does_has_retailunit')!=1 ) style="display: none;" @endif  id="retail_uom_idDiv"> 
        ...
        <div class="col-md-6 relatied_retial_counter "  @if(old('retail_uom_id')=="" ) style="display: none;" @endif> {{-- == is eqle sqaa  سواء كانت فاضية يعني دبل كوتيشن او كانت بنل  --}}{{-- اما ثلاث يساوي لازم تكون نل والدبل كوتيشن ساعتها مش نل --}}
                      ...
                      <div class="col-md-6">
                        <div class="form-group"> 
                          ...
                          <option   @if(old('has_fixced_price')==1) selected="selected"  @endif value="1"> نعم ثابت ولايتغير بالفواتير</option>
                           <option @if(old('has_fixced_price')==0 and old('has_fixced_price')!="" ) selected="selected"   @endif value="0"> لا وقابل للتغير بالفواتير</option>
                          </select>
