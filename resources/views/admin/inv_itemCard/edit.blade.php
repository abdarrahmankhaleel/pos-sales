...
<input name="barcode" id="barcode" class="form-control" value="{{ old('barcode',$data['barcode']) }}" placeholder="ادخل  باركود الصنف"  >
@error('barcode')
...
<div class="form-group"> 
  ...
  <option    
              {{ old('item_type',$data['item_type'])==1 ? 'selected' : ''}} value="1"> مخزني</option>
  <option   
              {{ old('item_type',$data['item_type'])==2 ? 'selected' : ''}} value="2"> استهلاكي بتاريخ صلاحية</option>
  <option 
              {{ old('item_type',$data['item_type'])==3 ? 'selected' : ''}} value="3"> عهدة</option>
  </select>
...
<div class="col-md-6"> 
  ...
  <div class="col-md-6"> 
    ...
    <div class="col-md-6"> 
      ...
      <div class="col-md-6  " @if(old('does_has_retailunit',$data['does_has_retailunit'])!=1 ) style="display: none;" @endif  id="retail_uom_idDiv"> 
        ...
        <div class="col-md-6 relatied_retial_counter "  @if(old('retail_uom_id',$data['retail_uom_id'])=="" ) style="display: none;" @endif> 
 ...
 <div class="col-md-6 relatied_parent_counter"  > 
        ...
        <div class="form-group">
          ...
          <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="price" id="price" class="form-control"  value="{{ old('price',$data['price']) }}" placeholder="ادخل السعر " >
          @error('price')
          <span class="text-danger">{{ $message }}</span>
          @enderror
          </div>
        ...
        <div class="col-md-6 relatied_parent_counter " > 
          <div class="form-group">
            ...
            <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="nos_gomla_price" id="nos_gomla_price" class="form-control"  value="{{ old('nos_gomla_price',$data['nos_gomla_price']) }}" placeholder="ادخل السعر " >
          ...
          <div class="col-md-6 relatied_parent_counter " > 
            <div class="form-group">
              ...
              <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="gomla_price" id="gomla_price" class="form-control"  value="{{ old('gomla_price',$data['gomla_price']) }}" placeholder="ادخل السعر " >
              @error('gomla_price')
              <span class="text-danger">{{ $message }}</span>
              @enderror
              </div>
            ...
            <div class="col-md-6 relatied_parent_counter " > 
              <div class="form-group">
                ...
                <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="cost_price" id="cost_price" class="form-control"  value="{{ old('cost_price',$data['cost_price']) }}" placeholder="ادخل السعر " >
                @error('cost_price')
                <span class="text-danger">{{ $message }}</span>
                @enderror
                </div>
              ...
              <div class="col-md-6 relatied_retial_counter " @if(old('retail_uom_id',$data['retail_uom_id'])=="" ) style="display: none;" @endif> 
                ...
                <div class="form-group">
                  ...
                  <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="price_retail" id="price_retail" class="form-control"  value="{{ old('price_retail',$data['price_retail']) }}" placeholder="ادخل السعر " >
                  @error('price_retail')
                  <span class="text-danger">{{ $message }}</span>
                  @enderror
                  </div>
                ...
                <div class="col-md-6 relatied_retial_counter " @if(old('retail_uom_id',$data['retail_uom_id'])=="") style="display: none;" @endif> 
                  <div class="form-group">
                    ...
                    <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="nos_gomla_price_retail" id="nos_gomla_price_retail" class="form-control"  value="{{ old('nos_gomla_price_retail',$data['nos_gomla_price_retail']) }}" placeholder="ادخل السعر " >
                  ...
                  <div class="col-md-6 relatied_retial_counter " @if(old('retail_uom_id',$data['retail_uom_id'])=="" ) style="display: none;" @endif> 
                    <div class="form-group">
                      ...
                      <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="gomla_price_retail" id="gomla_price_retail" class="form-control"  value="{{ old('gomla_price_retail',$data['gomla_price_retail']) }}" placeholder="ادخل السعر " >
                    ...
                    <div class="col-md-6 relatied_retial_counter " @if(old('retail_uom_id',$data['retail_uom_id'])=="" ) style="display: none;" @endif> 
                      <div class="form-group">
                        ...
                        <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="cost_price_retail" id="cost_price_retail" class="form-control"  value="{{ old('cost_price_retail',$data['cost_price_retail']) }}" placeholder="ادخل السعر " >
...
<div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <div class="image">
          <img id="uploadedimg" class="custom_img" src="{{ asset('assets/admin/uploads').'/'.$data['photo'] }}" alt="logo">
          <button id="btn_update_img" class="btn btn-sm btn-danger">تغير الصورة </button>
...
<div class="form-group" id="div_img">
      ...
      <div class="form-group text-center">
        <button id="do_edit_item_card" type="submit" class="btn btn-primary btn-sm"> اضافة</button>
...
@section('script')
 <script src="{{ asset('assets/admin')}}/js/inv_itemcard.js"></script> {{-- ctrl+f5 --}}
