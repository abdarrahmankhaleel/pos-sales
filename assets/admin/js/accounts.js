...
function make_search(){
  ...
  jQuery.ajax({
    ...
    dataType:'html',
    cache:false,
    data:{search_by_text:search_by_text,account_type_search:account_type_search,is_parent_search:is_parent_search,"_token":token_search,searchbyradio:searchbyradio},
